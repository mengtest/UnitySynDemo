...
public class CameraCtrlWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(CameraCtrl), typeof(UnityEngine.MonoBehaviour));
		...
		L.RegVar("smoothVerAngle", get_smoothVerAngle, set_smoothVerAngle);
	...
	static int GetH(IntPtr L)
	{
		try
		{
			...
			CameraCtrl obj = (CameraCtrl)ToLua.CheckObject<CameraCtrl>(L, 1);
			float o = obj.GetH();
	...
	static int init(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes<Player>(L, 2))
			{
				CameraCtrl obj = (CameraCtrl)ToLua.CheckObject<CameraCtrl>(L, 1);
				Player arg0 = (Player)ToLua.ToObject(L, 2);
				obj.init(arg0);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: CameraCtrl.init");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_smoothVerAngle(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			CameraCtrl obj = (CameraCtrl)o;
			float ret = obj.smoothVerAngle;
			LuaDLL.lua_pushnumber(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index smoothVerAngle on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_targetPivotOffset(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			CameraCtrl obj = (CameraCtrl)o;
			UnityEngine.Vector3 ret = obj.targetPivotOffset;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index targetPivotOffset on a nil value");
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_targetCamOffset(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			CameraCtrl obj = (CameraCtrl)o;
			UnityEngine.Vector3 ret = obj.targetCamOffset;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_smoothVerAngle(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_targetPivotOffset(IntPtr L)
	{
		object o = null;
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_targetCamOffset(IntPtr L)
	{
		object o = null;
