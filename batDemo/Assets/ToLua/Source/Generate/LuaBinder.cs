...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		ObjDataWrap.Register(L);
		WeaponDataWrap.Register(L);
		GunWrap.Register(L);
		ItemWrap.Register(L);
		...
		MonoSingleton_CameraManagerWrap.Register(L);
		ObjBaseWrap.Register(L);
		PoolObjWrap.Register(L);
		...
		L.RegFunction("Action_objects", System_Action_objects);
		...
		GameEnum_AniLabelWrap.Register(L);
		GameEnum_ActionLayerWrap.Register(L);
		GameEnum_JumpStateWrap.Register(L);
		GameEnum_ItemTypeWrap.Register(L);
		GameEnum_Weapon_GunTypeWrap.Register(L);
		GameEnum_Weapon_MeleeTypeWrap.Register(L);
		GameEnum_Weapon_GrenadeTypeWrap.Register(L);
		GameEnum_GunNameLinkWrap.Register(L);
		GameEnum_FireTypeWrap.Register(L);
		L.EndModule();
		...
		L.AddPreLoad("UnityEngine.RectTransformUtility", LuaOpen_UnityEngine_RectTransformUtility, typeof(UnityEngine.RectTransformUtility));
		L.EndPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_objects(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LuaOpen_UnityEngine_RectTransformUtility(IntPtr L)
	{
		try
		{
			LuaState state = LuaState.Get(L);
			state.BeginPreModule("UnityEngine");
			UnityEngine_RectTransformUtilityWrap.Register(state);
			int reference = state.GetMetaReference(typeof(UnityEngine.RectTransformUtility));
			state.EndPreModule(L, reference);
			return 1;
		}
		catch(Exception e)
