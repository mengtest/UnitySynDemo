...
////// Emissive:
                ...
                float3 emissive = (_diffuse_var.rgb*_node_3769.rgb*i.vertexColor.rgb);
                float3 finalColor = emissive;
                float4 node_8476 = _Time;
                float2 node_1227 = (i.uv0+float2((_maskU*node_8476.g),(node_8476.g*_maskV)));
                float4 _mask_var = tex2D(_mask,TRANSFORM_TEX(node_1227, _mask));
                return fixed4(finalColor,(_diffuse_var.a*_node_3769.a*i.vertexColor.a*_mask_var.a));
            }
            ENDCG
        }
    }
