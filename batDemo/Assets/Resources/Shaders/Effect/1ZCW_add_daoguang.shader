...
////// Emissive:
                ...
                float3 emissive = (_diffuse_var.rgb*i.vertexColor.rgb*_color.rgb*(_mask_var.r*saturate(((_dissolve_var.r*_soft)-lerp(_soft,(-1.5),i.uv1.r)))*i.vertexColor.a*_diffuse_var.a));
