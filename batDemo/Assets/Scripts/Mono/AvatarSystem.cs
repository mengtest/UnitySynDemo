...
public class AvatarSystem : MonoBehaviour
{
    ...
    public bool combineTexture = GameSettings.Instance.combineTexture;
    ...
    private ObjBase _objBase;
    
    public void Init(string aniUrl, string[] modelpaths,Action bodyFinedFun=null,ObjBase objBase=null)
    {
    ...
    IEnumerator LoadAvatar()
    {
        ...
        if(this._objBase!=null){
               this._objBase.ChangeNodeObj(this.mainObj,true);
        }else{
        ...
        while (iter.MoveNext())
        {
            ...
            string rootBoneName =   root["rootbones"].Value ;
         //   DebugLog.Log("rootBoneName ",rootBoneName);
             this.rootBone=null;
            this.rootBone= GameUtils.FindChildRecursively(this.mainObj.transform,rootBoneName);
         //    DebugLog.Log("rootBoneName ",this.rootBone);
        ...
        else
        {
            ...
            yield return resetAni();
        }
        inited = true;
    }
   IEnumerator resetAni(){
       if(isNewAnimatorSystem){
           Animator ani = mainObj.GetComponent<Animator>();
    ...
    IEnumerator AddPart(string partKey)
    {
     ...
     //   DebugLog.Log("rootBoneName ",rootBoneName);
        this.rootBone=null;
        this.rootBone= GameUtils.FindChildRecursively(this.mainObj.transform,rootBoneName);
     //   DebugLog.Log("rootBone ",this.rootBone);
